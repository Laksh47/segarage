...
class toolUpload(FlaskForm):
  ...
  readme_file = FileField('Upload Readme/instructions file', validators=[DataRequired()])
  scripts_file = FileField('Upload scripts/source code')
  all_in_one_file = FileField('Upload all in one zip file')
